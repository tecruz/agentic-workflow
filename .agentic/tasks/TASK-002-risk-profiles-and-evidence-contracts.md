...
| AC-3 | Fixture parity tests pass on both validators (76 fixtures) | Passed |
| AC-4 | WORKFLOW.md / AGENTS.md / README.md updated | Passed |
| AC-5 | Managed-file registration + bundle tests | Passed |
| AC-6 | Full bats + Pester suites green (76 fixtures validated on Bash + PS) — CI #65 | Passed |
...
- `tests/fixtures/tasks/*.md` (76 fixtures)
...
- CI #65 green at `d45e601` across Ubuntu, macOS, and Windows; the pipeline now
  also runs this task through both validators in `--handoff` mode (76 fixtures).
