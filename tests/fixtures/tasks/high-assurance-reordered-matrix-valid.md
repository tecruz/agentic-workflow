# TASK-042: High assurance reordered matrix valid fixture
...
- R-3: Session tokens expire after 15 minutes.
...
five failed attempts; short-lived signed session tokens.

## Requirement-to-evidence

| Requirement ID | Evidence | Result |
| --- | --- | --- |
| R-3 | Integration test `session_expiry_test.go` | Passed |
...
- AC-3: Session tokens expire automatically.
...
| AC-3 | Integration test `session_expiry_test.go` | Passed |

## Verification

### Baseline

- `go test ./...` → 56 passed, 0 failed.

### Final

- `go test ./...` → 58 passed, 0 failed.
