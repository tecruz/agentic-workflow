# TASK-068: Two R identifiers declared on one list entry
...
- R-1: [explicit requirement] and R-2: Real requirement
...
| R-2 | Security unit test `key_rotation_test.go` | Passed |
