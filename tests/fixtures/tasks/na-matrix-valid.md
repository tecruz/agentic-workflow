# TASK-074: Done high assurance with a substantive n/a matrix rationale
...
- R-1: The IdP adapter must be rate limited.
...
| --- | --- | --- |
| R-1 | N/A: This requirement covers the IdP adapter, which this task does not modify. | n/a |
