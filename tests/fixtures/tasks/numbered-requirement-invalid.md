# TASK-160: Numbered high-assurance requirement outside the evidence contract
...
1. R-2: Failed login attempts are rate limited.

## Risk analysis

Threat model: credential theft from disk and online brute force.
...
- [x] AG-1: Approved by mallory@example.com on 2026-08-19
