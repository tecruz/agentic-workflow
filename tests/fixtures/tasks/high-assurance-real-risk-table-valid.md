# TASK-060: High assurance Risk analysis as a real table
...
| Risk | Mitigation |
| --- | --- |
| Disk theft of the credential store | AES-GCM at rest with an Argon2id-derived key |
| Online brute force | Per-account lockout after five failed attempts |
