...
Tasks fixture for the spec-pipeline-chain eval scenario.

## Task goal

Implement the orders export endpoint with goal conditions for verification.

## Smoke verification

- [x] The endpoint ships with contract tests passing.
